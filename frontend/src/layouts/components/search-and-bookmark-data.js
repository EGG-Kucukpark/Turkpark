...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Takvim', route: { name: 'apps-calendar' }, icon: 'CalendarIcon', isBookmarked: true },

      { title: 'Yapılacaklar', route: { name: 'apps-todo' }, icon: 'CheckSquareIcon', isBookmarked: true },
