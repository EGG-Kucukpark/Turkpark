...
<body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased;">
    <div style="display: none;">This is an invoice for your purchase on undefined. Please submit payment by undefined
    </div>
                        ...
                        <tr>
                            <td class="sm-py-32 sm-px-24"
                                ...
                                <a href="http://panel.turkpark.com.tr">
                                    <img src="http://panel.turkpark.com.tr/public/images/logo2.png" width="155"
                                        alt="Vuexy Admin"
                                ...
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">İyi Günler
                                            </p>
                                            <p
                                                style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850; color: rgba(255, 88, 80, var(--text-opacity));">
                                                {{ $name }} !</p>
                                            <p style="margin: 0 0 24px;">
                                                İstediğiniz hizmete dair faturanızın detaylarını aşağıda bulabilirsiniz.
                                            </p>
                                                        ...
                                                        <table
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <strong>Toplam Ücret:</strong> {{ $tutar }} ₺
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                            ...
                                                            <tr>
                                                                <td align="right"
                                                                    ...
                                                                    <a href="https://example.com"
                                                                        style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;">Onaylıyorum
                                                                        &rarr;</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            ...
                                            <p
                                                ...
                                                Bu faturayla ilgili herhangi bir sorunuz varsa, bu e-postayı yanıtlayın
                                                veya yardım için destek ekibimizle iletişime geçin.

                                            </p>
                                            <p
                                                style="font-size: 14px; line-height: 24px; margin-top: 6px; margin-bottom: 20px;">
                                                Saygılarla,
                                                <br>Türkpark Destek Ekibi
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <p align="center" style="cursor: default; margin-bottom: 16px;">
                                    <a href="https://www.facebook.com/#"
                                        style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                            src="http://panel.Türkpark.com/public/images/facebook.png" width="17"
                                            alt="Facebook"
                                            style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                    &bull;
                                    <a href="https://twitter.com/#"
                                        style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                            src="http://panel.Türkpark.com/public/images/twitter.png" width="17"
                                            alt="Twitter"
                                            style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                    &bull;
                                    <a href="https://www.instagram.com/#"
                                        style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity)); text-decoration: none;"><img
                                            src="http://panel.Türkpark.com/public/images/instagram.png" width="17"
                                            alt="Instagram"
                                            style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle; margin-right: 12px;"></a>
                                </p>
                                <p
                                    style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity));">
                                    Hizmetimizin ve web sitemizin kullanımı Kullanım Koşullarımıza ve Gizlilik
                                    Politikamıza tabidir.
                                </p>
                            </td>
                        </tr>
                        <tr>
