        ...
        " width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            " bgcolor="rgba(236, 239, 241, var(--bg-opacity))">
                        ...
                        " bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                          ...
                          ">
                                            ...
                                            <p style="margin: 0 0 24px">
                                                İstediğiniz hizmete dair faturanızın detaylarını
                          ...
                          " width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                " cellpadding="0" cellspacing="0" role="presentation">
                                    ...
                                    position: relative;
                                      ...
                                      font-family: Montserrat, -apple-system,
                                        'Segoe UI', sans-serif;
                                    ">
                                                                    <a href="http://localhost:8000//hizmet-gecmisi/0"
                                                                        style="
                                        display: block;
                                        font-weight: 600;
                                        font-size: 14px;
                                    ...
                                    " bgcolor="rgba(115, 103, 240, var(--bg-opacity))">
                                                                    <a href="{{ url('hizmet-gecmisi/1/' . $id) }}" .
                                                                        style="
                                        display: block;
                                        font-weight: 600;
                                        font-size: 14px;
                            ...
                            margin-bottom: 20px;
                          ">
                                                Bu faturayla ilgili herhangi bir sorunuz varsa, bu
                                                e-postayı yanıtlayın veya yardım için destek
                  ...
                  ">
                        ...
                        text-decoration: none;
                      "><img src="http://panel.Türkpark.com/public/images/facebook.png" width="17" alt="Facebook"
                                            style="
                          border: 0;
                          max-width: 100%;
                          line-height: 100%;
                        ...
                        color: rgba(38, 50, 56, var(--text-opacity));
                        text-decoration: none;
                      "><img src="http://panel.Türkpark.com/public/images/twitter.png" width="17" alt="Twitter" style="
                          border: 0;
                          max-width: 100%;
                          line-height: 100%;
                          vertical-align: middle;
                        ...
                        color: rgba(38, 50, 56, var(--text-opacity));
                        text-decoration: none;
                      "><img src="http://panel.Türkpark.com/public/images/instagram.png" width="17" alt="Instagram"
                                            style="
                          border: 0;
                          max-width: 100%;
                          line-height: 100%;
                      ...
                      color: rgba(38, 50, 56, var(--text-opacity));
                    ">
                                    Hizmetimizin ve web sitemizin kullanımı Kullanım
                                    Koşullarımıza ve Gizlilik Politikamıza tabidir.
                                </p>
                            </td>
                        </tr>
                        <tr>
